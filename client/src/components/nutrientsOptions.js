const nutrientsOptions = [
    { label: 'minCarbs', value: 'minCarbs' },
    { label: 'maxCarbs', value: 'maxCarbs'},
    ...
    { label: 'maxCaffeine', value: 'maxCaffeine'},
    { label: 'maxCopper', value: 'maxCopper'},
    { label: 'maxCholine', value: 'maxCholine'},
  
  ];
  export default nutrientsOptions